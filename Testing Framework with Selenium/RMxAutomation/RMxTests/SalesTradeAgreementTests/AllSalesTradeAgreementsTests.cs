...
namespace RMxTests.SalesTradeAgreementTests
{
    ...
    class AllSalesTradeAgreementsTests: RMxTestsBaseClass
    {
        ...
        public void Added_SalesTradeAgreements_Show_Up()
        {
            ...
            NewTradeAgreementPage.GoTo();
            NewTradeAgreementPage.CreateTradeAgreement("Added TA Show up, name")
            ...
            Assert.IsTrue(NewTradeAgreementPage.DoesTradeAgreementExistWithName("Added TA Show up, name"), "Could not find the Sales Trace Agreement");
            
            // Delete SalesTradeAgreements (clean up)
            NewTradeAgreementPage.DeleteSalesTradeAgreement("Added TA Show up, name");
            ...
            Assert.IsFalse(NewTradeAgreementPage.DoesTradeAgreementExistWithName("Added TA Show up, name"), "Could not delete Sales Trade Agreement");
